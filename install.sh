...
if [[ $ARCHITECTURE = "NO CHECK" ]] ; then
  ...
  showHelp "Arm systems are not officially supported but you can give it a whirl anyway!"
elif [[ $ARCHITECTURE =~ .*i386.*|.*i686.* ]] ; then
  showHelp "32-bit systems are not supported but you can give it a whirl anyway!"
fi
